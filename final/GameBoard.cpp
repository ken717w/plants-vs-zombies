...
/*to insert the character on to the board*/
...
/*to get the command of the player*/
...
/*to know the cost of the character with the abbreviationof that charcter*/
...
/*to display the not enough cost statement*/
...
/*to ask the player which grid he want to create character*/
...
/*return true if there is at least one grid that the zombie can be created,fasle if not*/
...
/*return true if there is at least one grid that the plant can be created,fasle if not*/
...
/*always return false(if there is zombie on the y-123, create a plant that block the zombie)*/
...
/*to add sun and coins of the two players*/
...
/*return the number of the sunflower*/
